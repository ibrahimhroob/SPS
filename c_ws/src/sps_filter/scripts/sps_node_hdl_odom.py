...
class SPS():
    def __init__(self):
        ...
        self.cloud_tr_pub = rospy.Publisher('raw_cloud_tr_debug', PointCloud2, queue_size=10)
    ...
    def callback_odom(self, odom_msg):
        ...
        with self.lock:
            ...
            if self.pub_submap:
                ...
                self.submap_pub.publish(util.to_rosmsg(submap.numpy(), self.scan_msg_header, 'map'))
